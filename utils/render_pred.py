...
def get_obj_faces(annot_type: str):
    template_obj_path_dict = {
        ...
        'FLAME_5023_vertices': '/scratch3/wan451/3DTalk/Talking3DHead/resources/Template_FLAME_5023_vertices.obj',
...
def vis_model_out_proxy():
    import sys
    npz_path = "/scratch3/wan451/3DTalk/Talking3DHead/npz_results/demo_preds.npz"
    audio_dir = "/scratch3/wan451/3DTalk/Talking3DHead/test_data_short/test_audios"
    out_dir = "/scratch3/wan451/3DTalk/Talking3DHead/render_outputs/demo_preds"
    save_images = False 
    os.makedirs(out_dir, exist_ok=True)
    out_dict = dict(np.load(npz_path, allow_pickle=True))
    print(list(out_dict.keys()))
    annot_type = 'FLAME_5023_vertices'
    # wav_files = list(out_dict.keys())
